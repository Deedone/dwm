...
static const char col_cyan[]        = "#ff7f50";
...
{"VirtualBox Machine",NULL,     NULL,           0,         1,          0,           1,        -1, 0 },
	{ "St",      NULL,     "AAA",          0,         0,          0,           1,        -1, 0 },
	{ "St",      NULL,     NULL,           0,         0,          1,          -1,        -1, 0 },
	{ "St",      NULL,     "AAA",          0,         0,          0,           1,        -1, 0 },
	{ "FreeTube-Vue",NULL, NULL,           0,         0,          0,           1,        -1, 0 },
	{ NULL,      NULL,     "Event Tester", 0,         1,          0,           1,        -1, 0 }, /* xev */
	{ NULL,      NULL,     "Media viewer", 0,         1,          0,           1,        -1, 0 }, /* xev */
};
...
static const char *autostartcmd[] = { "/bin/sh", "-c","/home/mpoturai/autostart_blocking.sh", NULL};
...
static Key keys[] = {
	...
	{ MODKEY,			XK_p,      spawn,          SHCMD("i3lock") },
	{ MODKEY,			XK_o,      spawn,          SHCMD("firefox \"https://mail.google.com/mail/u/3/\"") },
	{ MODKEY|ShiftMask,		XK_o,      spawn,          SHCMD("firefox \"https://mail.google.com/mail/u/0/\"") },
	{ MODKEY,                       XK_d,      spawn,          {.v = dmenucmd } },
	{ MODKEY,                       XK_space,      spawn,          SHCMD("xkb-switch -n") },
